\begin{flushleft}
    \section{Analysis} 
        ...
        \subsection{Initial Research} 
            ...
            \subsubsection{Possible Algorithmic / Framework Solutions}
            There are, as afformentioned many existing solutions which work in various ways, in order to make my solution unique and functioning I am going to have to incoperate many different algorithms
            and theories. \\ \bk

            \paragraph{Edge Detection} \mbox{} \\
            First of all I will need some way of recognising a map and parseing it in some way. The way that first springs to mind is edge detection. This is a way of taking an image and computing where there
            ...
            A simple edge detection model can be extreemly effected by natural blur or artifacts in an image. In order to mittigate this there are smoothing algorithms that can be used to blur and smooth edges
            causing the impact of artifacts to be avoided. The common term when refering to artifacts and erronious data in an image is \emph{noise}. I believe it will be beneficial to include some of these
            in my solution, this will be something to look into in the \textbf{Further Reaserch} section. \\ \bk

            Taking a quick look at one form of edge detection, Canny Edge detection, it is reletavly simple in its implementation. It has only 5 steps, first removing noise with a guassian filter then applying
            bounding to the image and finaly performing hysteresis thresholding. This is the most common form of edge detection that I have come accross in my reaserch however there are others. A rather
            ...
            Overall there seem to be many different ideas on how to do edge detection which I will have to look into to pick a specific version in the \textbf{Further Reaserch} section. \\ \bk

            \paragraph{Graph Searching} \mbox{} \\
            \bk

            \paragraph{Graph Routing} \mbox{} \\
            \bk

            \paragraph{Creation of a MST} \mbox{} \\
            \bk
            ...
            After doing my initial reaserch and a brief look at the existing solutions I have come up with, what I feel, is the main 4 Components that I will need to build my solution. \\ \bk
        ...
        \subsection{Further Research}
            ...
            Moving onto the specific algorithms, in the next section I will be looking into algorithm that I could be implementing in detail.
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                \item At a glance the user should be able to accertain which step they are at in the process.
            \end{enumerate}
