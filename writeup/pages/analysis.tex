\begin{flushleft}
    \section{Analysis} 
        ...
        \subsection{Further Research}
            ...
            industry standared since it takes into account how prevelent red, green and blue are rather than taking an average which could become non representing of the real case. \\ \bk
            \bk
            $
                \mathlarger {
            ...
            of the image, sometimes refered to as a kernel and performing an equation on it. Once it has computed the equation it sets all of the pixels inside the kernel to this value. The following is true 
            for a kernel size of $(2k + 1) * (2k + 1)$. It takes two changable parameters $\sigma$ which denotes the amount of blur to apply and $k$ is the kernel size. \\ \bk
            \bk
            $
                H_{ij} = \frac{1}{
                    2\pi\sigma^{2}
