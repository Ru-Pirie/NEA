...
\begin{flushleft}
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Async Edge Detection Class Diagram]{{\includegraphics[width=12.5cm]{images/UML/AsyncEdgeDetection.png}}}
    \end{figure}\\
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Canny Result Class Diagram]{{\includegraphics[width=12.5cm]{images/UML/CannyResult.png}}}
    \end{figure}\\
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Coord Class Diagram]{{\includegraphics[width=12.5cm]{images/UML/Coord.png}}}
    \end{figure}\\
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Gradients Class Diagram]{{\includegraphics[width=12.5cm]{images/UML/Gradients.png}}}
    \end{figure}\\
